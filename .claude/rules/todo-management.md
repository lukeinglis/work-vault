...
**Structure:** Five table sections: `This Week` (with Due column), `Next Up`, `Ongoing` (persistent efforts without a due date), `Someday / Backlog`, `Done (Last 7 Days)` (with Completed column). Tag with initiative: `#<component-slug>` (matching your 01-Components/ folder names).
