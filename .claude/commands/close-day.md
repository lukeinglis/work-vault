...
- Write a concise `**Summary:**` for the day:
  ...
  - Write in the user's voice: concise, no fluff, no hedging, no emdash
...
3. Write a curated summary to `02-Weekly/_summaries/YYYY-Www-summary.md`:
   ...
   - Write in the user's voice: concise, bullet-heavy, no fluff, no hedging
...
Summary: Finalized Q3 blog post, aligned with team on release notes. Blocker: partner engineering outreach stalled. Shipped vault tooling updates across 3 PRs.
```
